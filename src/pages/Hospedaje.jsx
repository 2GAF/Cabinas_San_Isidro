...
export function Hospedaje() {
        ...
        return (
            <div className="flex justify-center py-5 md:py-14">
                <button className="w-custom-img relative py-3" onClick={manejarClick} ref={tarjetaRef}>
                    ...
                    <div className={`${topClass} ${positionClass} ${sizeClass} bg-blue-1 font-outfit text-white flex items-center justify-center shadow-black shadow-lg rounded-lg transition-transform duration-500 ease-in-out ${transformClass}`}>
    ...
    return (
        <div>
            ...
            <h1 className="text-[#2C5CA3] my-[2.875rem] font-semibold text-center font-outfit text-[clamp(26px,_2.8vw,_3.438rem)] leading-none">¡Conoce nuestras opciones de hospedaje!</h1>
