...
export function Header() {
  ...
  return (
    <div className="flex items-center justify-between mx-[0.938rem] my-[0.938rem] md:mx-[3.75rem] md:my-[2.875rem]">
      ...
      <nav className={`fixed top-0 left-0 h-full text-center pt-[1.625rem] transition-transform transform ${menuOpen ? 'translate-x-0 text-white bg-black' : '-translate-x-full'} lg:static lg:transform-none lg:flex lg:justify-center lg:w-full`}>
